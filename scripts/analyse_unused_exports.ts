...
// VERJI - default exports whose call sites in RoomView.tsx are currently commented out;
// retained for re-enablement/upstream-port parity.
ignore.push("/Searching.ts");
ignore.push("/VerjiLocalSearch.ts");
